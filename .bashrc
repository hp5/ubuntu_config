...
# add pkgconfig path
export PKG_CONFIG_PATH=/home/hp5/.local/pkgconfig
...
# add qt root.
export QTROOT=/home/hp5/Documents/Qt/5.13.2/gcc_64
export PATH=$QTROOT/bin:$PATH
export LD_LIBRARY_PATH=$QTROOT/lib:$LD_LIBRARY_PATH
# add g++ include path
export CPLUS_INCLUDE_PATH=/home/hp5/Documents/openCV/include
...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\A:\[\033[01;34m\]\W\[\033[01;31m\]\$ \[\033[00m\]'
else
    PS1='${debian_chroot:+($debian_chroot)}\u@\h:\w\$ '
fi
unset color_prompt force_color_prompt

# If this is an xterm set the title to user@time:dir
case "$TERM" in
xterm*|rxvt*)
